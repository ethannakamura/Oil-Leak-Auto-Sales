...
const Home = props => {
    ...
    useEffect(() => {
        console.log(`Rendered or rerendered home! Nmumber of makes: ${props.makes.length}.`);
    });
                    ...
                    <div className="col-6">
                        <table className="table">
                            <thead>
                                ...
                                <tr>
                                    <th><button className="btn btn-sm btn-info btn-danger" onClick={addMakes}>Add a Make</button></th>
                                </tr>
                            </thead>
                            <tbody>
                                {
